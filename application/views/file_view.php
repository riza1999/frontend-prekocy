        ...
        <div class="container px-5 pt-5">
            <div class="row gx-5 justify-content-center pt-5">
                <div class="col-xl-8 pt-5">
                    ...
                    <button class="btn btn-primary mx-auto d-block rounded-pill px-4 mb-4" id="btnDownload" ><i class="bi bi-arrow-down"></i>Download Template Excel</button>
                    <div class="input-group mb-4 px-5">
                        <input id="inputFile" type="file" class="form-control rounded-pill" name="upload_file">
                    </div>
                    <button type="submit" class="btn btn-primary mx-auto d-block rounded-pill px-4" id="btnUpload"><i class="bi bi-arrow-up"></i>Upload</button>
                    <?php echo form_close(); ?>
                </div>
            </div>
        </div>
